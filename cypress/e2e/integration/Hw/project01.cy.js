...
*/
  ...
  it('Test Case 02 - Validate the Full name input box', () => {
    ...
    // cy.get('label[for="name"] + .control > input').should('have.attr', 'placeholder', 'Enter your full name')
  })
...
*/
    ...
    const expectedOptions = ['Female', 'Male', 'Prefer not to disclose']
...
*/
  ...
  it('Test Case 06 - Validate the Phone input box', () => {
    ...
    cy.get(':nth-child(5) > .control > input')
      .should('be.visible')
      .and('have.attr', 'placeholder', 'Enter your phone number') // Unclear requirement, assuming "Phone" input box NOT address- Validate that the placeholder of the Address input box is “Enter your phone number”
      .and('not.have.attr', 'required')
...
*/
  ...
  it('Test Case 07 - Validate the Message text area', () => {
    ...
    // FAILED - text is using elipsis … not regular periods ...
